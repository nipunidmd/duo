		...
		<div class="header-container container d-flex h-100">
			<div class="header-column flex-row flex-lg-column justify-content-center h-100">
				<div class="header-row flex-row justify-content-start justify-content-lg-center" style="padding-bottom: 20px;">
					<div class="header-logo">
						<a href="<?php echo e(route('home')); ?>">
							<img alt="Duo" width="125" src="<?php echo e(('assets/img/duo_images/logo1.jpg')); ?>">
						</a>
					</div>
				</div>
						...
						<div class="header-nav-main header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-4 header-nav-main-sub-effect-1">
							<nav class="collapse">
								<ul class="nav nav-pills" id="mainNav">	
									...
									<li>
										<a class="nav-link" href="<?php echo e(route('about-us')); ?>">
											About Us
										</a>
									</li>
									<li class="dropdown">
										...
										<ul class="dropdown-menu">
											...
											<li>
												<a class="dropdown-item" href="<?php echo e(route('project')); ?>">
													Projects
												</a>
											</li>
											<li>
												<a class="dropdown-item" href="<?php echo e(route('gallery')); ?>">
													Gallery
												</a>
											</li>
										</ul>
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu">
											...
											<li>
												<a class="dropdown-item" href="<?php echo e(route('under-construction')); ?>">
													Under Construction
												</a>
											</li>
											<li>
												<a class="dropdown-item" href="<?php echo e(route('proposal')); ?>">
													Proposals
												</a>
											</li>
										</ul>
				...
				<div class="header-row flex-row justify-content-start justify-content-lg-center" style="padding: 0px 1px 0px 10px">
					<div class="header-logo">
						<a href="<?php echo e(route('home')); ?>">
							<img alt="Porto" width="85" src="<?php echo e(('assets/img/duo_images/main_logo.jpg')); ?>">
						</a>
					</div>
				</div>
