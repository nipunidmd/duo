							...
							<div class="sort-destination-loader sort-destination-loader-showing">
								<div class="row mb-4 pt-1 portfolio-list sort-destination" data-sort-id="portfolio">
									...
									<div class="col-md-6 col-lg-4 isotope-item mb-4 residential">
										<a href="<?php echo e(route('search.project',$project->slug)); ?>">
											<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
												<span class="thumb-info-wrapper">
													<img src="<?php echo e(asset($project->image)); ?>" class="img-fluid" alt="">
										...
										<h4 class="mt-3 mb-0"><?php echo e($project->name); ?></h4>
										<p class="mb-0"><?php echo e($project->location); ?></p>
									</div>

									<?php elseif($project->type == 1): ?>
