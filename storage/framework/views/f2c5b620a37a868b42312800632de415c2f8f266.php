				...
				<div class="container">
					...
					<div class="row mt-4 pt-4 mb-4 pb-4">
							...
							<div class="row mb-4">
								<div class="col-lg-6">
									<ul class="list list-icons list-icons-style-2 text-color-primary">
										...
										<li><a href="<?php echo e(route('contact-us')); ?>"><i class="far fa-envelope"></i>test@duo.com</a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							...
							<form id="contactForm" class="contact-form form" action="<?php echo e(route('send')); ?>" method="POST">
								<?php echo csrf_field(); ?>
