              ...
              <div class="header">
                <span class="pull-right">
                  <a href="{{route('projects.index')}}" class="btn btn-primary btn-sm">PROJECT LIST</a>
                    ...
                    <h2>
                        UPDATE PROJECTS
                        <small>update projects in the system</small>
                    </h2>
                </div>
                ...
                <div class="body">
                  <div class="row clearfix">
                    ...
                    <div class="col-sm-6" style="margin-bottom:5%">
                      <label for="title">Project Type</label>
                        <select class="form-control show-tick" name="project_type" id="project_type">
                          ...
                          @elseif($projects->type == 1)
                            <option value="0">Residential</option>
                            <option value="1" selected>Commercial</option>
                            <option value="2">Leisure</option>
                            <option value="3">Industrial</option>
                            <option value="4">Public</option>
                          @elseif($projects->type == 2)
                            <option value="0">Residential</option>
                            <option value="1">Commercial</option>
                            <option value="2" selected>Leisure</option>
                            <option value="3">Industrial</option>
                            <option value="4">Public</option>
                          @elseif($projects->type == 3)
                            <option value="0">Residential</option>
                            <option value="1">Commercial</option>
                            <option value="2">Leisure</option>
                          ...
                          @else
                            ...
                            <option value="2">Leisure</option>
                            <option value="3">Industrial</option>
                            <option value="4" selected>Public</option>
                          @endif
                        </select>
                    </div>
                    <div class="col-sm-6" style="margin-bottom:5%">
                      <label for="title">Project Status</label>
                        <select class="form-control show-tick" name="project_status" id="project_status">
                          ...
                          @else
                            <option value="0">Past</option>
                            <option value="1">Ongoing</option>
                            <option value="2" selected>Proposal</option>
                          @endif
                        </select>
                    </div>
                    ...
                    <div class="cropped col-xs-12">
                        <br><br>
                      <img src="{{url('../'.$projects->image)}}" style="max-width:100%;">
                    </div>
                      ...
                      <div>
                        ...
                        <div id="imagesBundleContent"></div>
                          <div>
                            ...
                            <div>
                            <input type="file" multiple id="imagesBulkUploadInput" data-max-count="4">
                            <label class="custom-file-label" for="imagesBulkUploadInput">Choose images</label>
                            </div>
                          </div>
                        </div>
                      </div>
                      @foreach($project_data->images as $old_image)
...
@push('moreJs')
  ...
  var ajaxURL = base_url+"/projects/{{$projectid}}/update"
  var SSPEnable = false
